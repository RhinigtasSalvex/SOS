...
to-report fittness_function_3 [x y]
  let x1 5 /  max-x * x ; scale x to have a value from -5 to 5
  let y1 5 /  max-y * y ; scale x to have a value from -5 to 5
